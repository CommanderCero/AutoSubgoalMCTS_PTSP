...
public class ExperimentsNoveltyExploration extends Exec
{
    public static void runExperiments(int trials, double explorationRate, boolean useDynamic, String explorationString) throws IOException
    {
        if(explorationString == null)
        {
            explorationString = String.format("%.2f", explorationRate);
        }
        ...
        AutoSubgoalController.useDynamicNoveltyExplorationRate = useDynamic;
        AutoSubgoalController.explorationRate = explorationRate;
        runExperiments(trials, String.format("QD-MCTS-%s-%s", useDynamic ? "Dynamic" : "Static", explorationString));
    }
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        // 0.01
        //runExperiments(numTrials, 0.01, false, "0.01");
        //runExperiments(numTrials, 0.01, true, "0.01");
        // Sqrt(2)
        //runExperiments(numTrials, Math.sqrt(2), false, "Sqrt(2)");
        //runExperiments(numTrials, Math.sqrt(2), true, "Sqrt(2)");
        // 4
        //runExperiments(numTrials, 4, false, "4");
        //runExperiments(numTrials, 4, true, "4");

        // 10 - No dynamic exploration rate, since the previous experiments show that dynamic is worse
        //runExperiments(numTrials, 10, false, "10");
        // 0.5
        runExperiments(numTrials, 0.5, false, "0.5");
